...
public abstract class ContextFrifloEcsFullParallel : ContextBase
{
	static ContextFrifloEcsFullParallel() =>
		Schema.Create();

	private SystemRoot? _root;

	public ContextFrifloEcsFullParallel()
		: base("Friflo Ecs Full Parallel") {}
